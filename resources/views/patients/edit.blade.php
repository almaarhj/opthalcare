                    ...
                    <form action="{{ route('app.patients.update', $patient->id) }}" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="residential_address" id="residential_address" cols="30" rows="10" class="form-control">{{ $patient->residential_address }}</textarea>
                            </div>
                            <div class="col-md-6">
                                <label for="state_o" class="form-label">State of Origin</label>
                                <select name="state_of_origin" id="state_o" class="form-control">
                                    <option value="{{ $patient->state_origin }}" selected>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="lga_of_origin" id="lga_o" class="form-control">
                                    <option value="{{ $patient->lga_origin }}" selected>
                                        {{ $patient->lga_of_origin }}
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="text" name="next_of_kin_name"
                                    value="{{ old('next_of_kin_name', isset($patient) ? $patient->user->nok->next_of_kin_name : '') }}"
                                    class="form-control">
                            </div>
                            <div class="col-md-4">
                                ...
                                <select name="next_of_kin_relation" id="nok_relation" class="form-control">
                                    <option value="{{ $patient->user->nok->next_of_kin_relation }}" selected>
                                        {{ $patient->user->nok->next_of_kin_relation }}</option>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="next_of_kin_phone"
                                    value="{{ old('next_of_kin_phone', isset($patient) ? $patient->user->nok->next_of_kin_phone : '') }}"
                                    class="form-control">
                            </div>
                            <div class="col-md-12">
                                <label for="nok_address" class="form-label">Next of Kin's Address </label>
                                <textarea name="next_of_kin_address" id="" cols="30" rows="10" class="form-control">{{ $patient->user->nok->next_of_kin_address }}</textarea>
                            </div>
                            <div class="col-md-4">
