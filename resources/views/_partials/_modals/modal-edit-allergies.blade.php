    ...
    <div class="modal-dialog modal-lg modal-simple modal-edit-user">
        ...
        <div class="modal-content p-3 p-md-5">
            ...
            <div class="col-12 col-md-12">
                        ...
                        <input type="text" name="allergen" class="form-control" placeholder="allergen name" wire:model.prevent="allergen" />
                    </div>
                    <div class="col-12 col-md-12">
                        <label class="form-label"> Reation To Allergen</label>
                        <input type="text" name="reaction_to_allergen" class="form-control" placeholder="I get dizzy" wire:model.prevent="reactionToAllergen" />
                    </div>

                      <div class="col-12 text-center">
                        <button type="submit" class="btn btn-primary me-sm-3 me-1">Submit</button>
                         <a href="{{ $drawUrl }}" class="btn btn-label-secondary" target="_blank">Draw</a>
                    </div>
                </form>
            </div>
        </div>
