    ...
    <div class="page-section">
        <div class="section-block"><!-- metric row -->
            <div class="metric-row">
                <div class="col-lg-3">
                    <div href="javascript:" class="card-metric- metric metric-bordered">
                        <div class="metric-badge"><span class="badge badge-lg badge-dark"><span
                                    class="oi oi-media-record pulse mr-1"></span> Patients in Wait</span></div>
                        <p class="metric-value h3"><sub><i class="oi oi-timer"></i></sub><span class="value ml-2">0</span>
                        </p><a href="/queue" class="text-right">... Details</a>
                    </div><!-- /.metric -->
                </div><!-- /metric column -->
                <div class="col-lg-9">
                    <div class="metric-row metric-flush">
                        <div class="col">
                            <div href="javascript:" class="card-metric- metric metric-bordered align-items-center-">
                                <h2 class="metric-label">Patients Visits</h2>
                                <p class="metric-value h3"><sub><i class="oi oi-people"></i></sub><span
                                        class="value ml-2">0</span></p><a href="#" class="text-right">... Details</a>
                            </div>
                        </div>
                        <div class="col">
                            <div href="javascript:" class="card-metric- metric metric-bordered align-items-center-">
                                <h2 class="metric-label">Patient Registrations</h2>
                                <p class="metric-value h3"><sub><i class="oi oi-people"></i></sub><span
                                        class="value ml-2">0</span></p><a href="#" class="text-right">... Details</a>
                            </div>
                        </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="card-metric">
                        <div class="metric py-3">
                            <h2 class="metric-label"><a href="/reports/general/">General Reports</a></h2>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="card-metric">
                        <div class="metric py-3">
                            <h2 class="metric-label"><a href="/reports/pharmacy/">Extended Pharmacy Reports</a></h2>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="card-metric">
                        <div class="metric py-3">
                            <h2 class="metric-label"><a href="/reports/lab/">Extended Laboratory Reports</a></h2>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="card-metric">
                        <div class="metric py-3">
                            <h2 class="metric-label"><a href="/reports/radiology/">Extended Radiology Reports</a></h2>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="card-metric">
                        <div class="metric py-3">
                            <h2 class="metric-label"><a href="/reports/procedures/">Extended Procedures Reports</a></h2>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="card-metric">
                        <div class="metric py-3">
                            <h2 class="metric-label"><a href="/reports/immunization">Extended Immunization Reports</a></h2>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="card-metric">
                        <div class="metric py-3">
                            <h2 class="metric-label"><a href="/reports/billing">Extended Billing Reports</a></h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row"><!-- grid column -->
            <div class="col-12 col-lg-12 col-xl-6">
                <div class="card card-fluid pb-3 match-height" style="height: 532px;">
                    <div class="card-header">Patients attended to at Pharmacies</div><!-- .list-group -->
                    <div class="list-group list-group-flush"><!-- .list-group-item -->
                        <div class="list-group-item">
                            <div class="list-group-item-body">
                                <h5 class="card-title"><a href="javascript:">ABUJA PHARMACY</a></h5>
                                <p class="card-subtitle text-muted mb-1">Prescriptions: 0</p><!-- .progress -->
                                <div class="progress progress-sm bg-transparent-">
                                    <div class="progress-bar bg-danger" role="progressbar" aria-valuenow="0"
                                        aria-valuemin="0" aria-valuemax="100" style="width: 0%"><span class="sr-only">0%
                                            Complete</span></div>
                                </div><!-- /.progress -->
                        ...
                        <div class="list-group-item">
                            <div class="list-group-item-body">
                                <h5 class="card-title"><a href="javascript:">ABUJA Pharmacy(don't use)</a></h5>
                                <p class="card-subtitle text-muted mb-1">Prescriptions: 0</p><!-- .progress -->
                                <div class="progress progress-sm bg-transparent-">
                        ...
                        <div class="list-group-item">
                            <div class="list-group-item-body">
                                <h5 class="card-title"><a href="javascript:">GOMBE PHARMACY</a></h5>
                                <p class="card-subtitle text-muted mb-1">Prescriptions: 0</p><!-- .progress -->
                                <div class="progress progress-sm bg-transparent-">
                        ...
                        <div class="list-group-item">
                            <div class="list-group-item-body">
                                <h5 class="card-title"><a href="javascript:">SOKOTO PHARMACY</a></h5>
                                <p class="card-subtitle text-muted mb-1">Prescriptions: 0</p><!-- .progress -->
                                <div class="progress progress-sm bg-transparent-">
                                    <div class="progress-bar bg-danger" role="progressbar" aria-valuenow="0"
                                        aria-valuemin="0" aria-valuemax="100" style="width: 0%"><span class="sr-only">0%
