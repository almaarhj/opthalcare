        ...
        <div class="table-responsive">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="align-middle"><a href="/procedures/requests/9/">July 8, 2023, 6:11 p.m.</a></td>
                        <td class="align-middle">Musbahu, Aliyu [CID014957] </td>
                        <td class="align-middle">AMBULANCE SERVICE</td>
                        <td class="align-middle">EMERGENCY SERVICES</td>
                        <td class="align-middle">Active</td>
                        <td class="align-middle text-right">
                            <div class="dropdown">
                                <button type="button" class="btn btn-sm btn-icon btn-light" data-toggle="dropdown"
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="lab-request-action- dropdown-item" href="/procedures/requests/9/">
                                        Open Instance
                                    </a>

                                    <button class="dropdown-item" data-toggle="question" data-question="Cancel Request?"
                                        data-remote="/procedures/requests/9/cancel" type="button">
                                        Cancel Procedure
                                    </button>
                    ...
                    <tr>
                        <td class="align-middle"><a href="/procedures/requests/10/">July 12, 2023, 5:42 p.m.</a></td>
                        <td class="align-middle">Mubarak, Sani [CID015166] </td>
                        <td class="align-middle">AMBULANCE SERVICE</td>
                        <td class="align-middle">EMERGENCY SERVICES</td>
                        <td class="align-middle">Active</td>
                        <td class="align-middle text-right">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="lab-request-action- dropdown-item" href="/procedures/requests/10/">
                                        Open Instance
                                    </a>

                                    <button class="dropdown-item" data-toggle="question" data-question="Cancel Request?"
                                        data-remote="/procedures/requests/10/cancel" type="button">
                                        Cancel Procedure
                                    </button>
                    ...
                    <tr>
                        <td class="align-middle"><a href="/procedures/requests/11/">July 14, 2023, 2:17 p.m.</a></td>
                        <td class="align-middle">Musa, Buhari [CID015231] </td>
                        <td class="align-middle">AMBULANCE SERVICE</td>
                        <td class="align-middle">EMERGENCY SERVICES</td>
                        <td class="align-middle">Active</td>
                        <td class="align-middle text-right">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="lab-request-action- dropdown-item" href="/procedures/requests/11/">
                                        Open Instance
                                    </a>

                                    <button class="dropdown-item" data-toggle="question" data-question="Cancel Request?"
                                        data-remote="/procedures/requests/11/cancel" type="button">
                                        Cancel Procedure
                                    </button>
                    ...
                    <tr>
                        <td class="align-middle"><a href="/procedures/requests/12/">July 17, 2023, 5:28 p.m.</a></td>
                        <td class="align-middle">Lauwali, Ibrahim [CID015329] </td>
                        <td class="align-middle">AMBULANCE SERVICE</td>
                        <td class="align-middle">EMERGENCY SERVICES</td>
                        <td class="align-middle">Active</td>
                        <td class="align-middle text-right">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="lab-request-action- dropdown-item" href="/procedures/requests/12/">
                                        Open Instance
                                    </a>

                                    <button class="dropdown-item" data-toggle="question" data-question="Cancel Request?"
                                        data-remote="/procedures/requests/12/cancel" type="button">
                                        Cancel Procedure
                                    </button>
                    ...
                    <tr>
                        <td class="align-middle"><a href="/procedures/requests/13/">July 18, 2023, 9:28 a.m.</a></td>
                        <td class="align-middle">Yusuf, Auwalu [CID015337] </td>
                        <td class="align-middle">AMBULANCE SERVICE</td>
                        <td class="align-middle">EMERGENCY SERVICES</td>
                        <td class="align-middle">Active</td>
                        <td class="align-middle text-right">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="lab-request-action- dropdown-item" href="/procedures/requests/13/">
                                        Open Instance
                                    </a>

                                    <button class="dropdown-item" data-toggle="question" data-question="Cancel Request?"
                                        data-remote="/procedures/requests/13/cancel" type="button">
                                        Cancel Procedure
                                    </button>
                    ...
                    <tr>
                        <td class="align-middle"><a href="/procedures/requests/14/">July 20, 2023, 9:51 a.m.</a></td>
                        <td class="align-middle">Garba, Haruna [CID015422] </td>
                        <td class="align-middle">AMBULANCE SERVICE</td>
                        <td class="align-middle">EMERGENCY SERVICES</td>
                        <td class="align-middle">Active</td>
                        <td class="align-middle text-right">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="lab-request-action- dropdown-item" href="/procedures/requests/14/">
                                        Open Instance
                                    </a>

                                    <button class="dropdown-item" data-toggle="question" data-question="Cancel Request?"
                                        data-remote="/procedures/requests/14/cancel" type="button">
                                        Cancel Procedure
                                    </button>
                    ...
                    <tr>
                        <td class="align-middle"><a href="/procedures/requests/15/">July 24, 2023, 10:58 a.m.</a></td>
                        <td class="align-middle">Bello, Harisu [CID015552] </td>
                        <td class="align-middle">AMBULANCE SERVICE</td>
                        <td class="align-middle">EMERGENCY SERVICES</td>
                        <td class="align-middle">Active</td>
                        <td class="align-middle text-right">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="lab-request-action- dropdown-item" href="/procedures/requests/15/">
                                        Open Instance
                                    </a>

                                    <button class="dropdown-item" data-toggle="question" data-question="Cancel Request?"
                                        data-remote="/procedures/requests/15/cancel" type="button">
                                        Cancel Procedure
                                    </button>
                    ...
                    <tr>
                        <td class="align-middle"><a href="/procedures/requests/16/">July 26, 2023, 6:27 p.m.</a></td>
                        <td class="align-middle">Adesanya, Balkisu [CID015708] </td>
                        <td class="align-middle">AMBULANCE SERVICE</td>
                        <td class="align-middle">EMERGENCY SERVICES</td>
                        <td class="align-middle">Active</td>
                        <td class="align-middle text-right">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="lab-request-action- dropdown-item" href="/procedures/requests/16/">
                                        Open Instance
                                    </a>

                                    <button class="dropdown-item" data-toggle="question" data-question="Cancel Request?"
                                        data-remote="/procedures/requests/16/cancel" type="button">
                                        Cancel Procedure
                                    </button>
                    ...
                    <tr>
                        <td class="align-middle"><a href="/procedures/requests/17/">July 28, 2023, 5:01 p.m.</a></td>
                        <td class="align-middle">Dije, Galadima [CID015229] </td>
                        <td class="align-middle">AMBULANCE SERVICE</td>
                        <td class="align-middle">EMERGENCY SERVICES</td>
                        <td class="align-middle">Active</td>
                        <td class="align-middle text-right">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="lab-request-action- dropdown-item" href="/procedures/requests/17/">
                                        Open Instance
                                    </a>

                                    <button class="dropdown-item" data-toggle="question" data-question="Cancel Request?"
                                        data-remote="/procedures/requests/17/cancel" type="button">
                                        Cancel Procedure
                                    </button>
